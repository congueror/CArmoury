...
public enum ModArmorMaterial implements IArmorMaterial
{
	...
	STEEL(CArmoury.MOD_ID + ":steel", 29, new int[] {2, 5, 7, 2}, 8, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.5f, 0.0f, () -> {
	...
	RUBY(CArmoury.MOD_ID + ":ruby", 16, new int[] {3, 5, 7, 3}, 8, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.5f, 0.0f, () -> {
